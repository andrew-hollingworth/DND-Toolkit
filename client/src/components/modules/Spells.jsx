      ...
      <Card className={classes.card}>
        <CardContent>
          <Typography variant="h5" component="h2">
            <span className='scaly-b'>Spells</span>
          </Typography>
          <Typography variant="h6" component="h3">
            <span className='scaly-b'>Spells and magic oh my!</span>
          </Typography>
          <Typography variant="body2" component="p">
            <span className='scaly'>There will be some fantastical spells here! They'll be sortable and searchable!</span>
          </Typography>
        </CardContent>
      </Card>
    </>
